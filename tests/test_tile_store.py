...
import pytest
from titiler.openeo.services.base import NoTileAvailableError, TileAlreadyLockedError, TileNotAssignedError
...
def test_release_tile(tile_store):
    ...
    # Release the tile
    released = tile_store.release_tile(
        service_id="test_service",
        user_id="test_user"
    )
    ...
    assert tile_store.get_user_tile(
        service_id="test_service",
        user_id="test_user"
    ) is None
...
def test_submit_tile(tile_store):
    ...
    # Submit the tile
    submitted = tile_store.submit_tile(
        service_id="test_service",
        user_id="test_user"
    )
...
def test_get_user_tile(tile_store):
    ...
    user_tile = tile_store.get_user_tile(
        service_id="test_service",
        user_id="test_user"
    )
...
def test_complex_scenario(tile_store):
    ...
    released_tile = tile_store.release_tile(
        service_id="test_service",
        user_id="user1"
    )
