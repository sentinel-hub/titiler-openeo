...
@pytest.fixture
def udp_store() -> LocalUdpStore:
    """Create an in-memory Local UDP store."""
    return LocalUdpStore()


def test_upsert_and_get_udp(udp_store: LocalUdpStore):
...
def test_upsert_replaces_existing(udp_store: LocalUdpStore):
...
def test_user_isolation_on_upsert_and_delete(udp_store: LocalUdpStore):
...
def test_list_with_pagination(udp_store: LocalUdpStore):
